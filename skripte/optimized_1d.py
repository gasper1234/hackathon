...
N_species = 2  # Število beljakovin (prvi je želeni, ostali so nečistoče)
...
zac_conc = (1, 1)  # Začetna koncentracija beljakovin
...
t_max = 5.0
required_purity = 0.7
u_array = np.linspace(0.025, 0.025, int(t_max)) / (1 - delez_smole)
...
if __name__ == "__main__":
    ...
    purity = [0.01 * i for i in range(1, 101)]
